...
const SUPABASE_URL = "https://nphcswznuhwshlhqkdiw.supabase.co"; // Kendi Supabase URL'niz
const SUPABASE_ANON_KEY = "sb_publishable_NyfEJDu8OMrkshPFEOCIhg_oahFTAbJ";                  // Kendi Supabase Anon Key'iniz

// Supabase İstemcisi
let supabaseClient = null;
if (typeof supabase !== 'undefined' && SUPABASE_URL !== "https://nphcswznuhwshlhqkdiw.supabase.co") {
